...
The ServiceNow REST API provides endpoints for managing knowledge bases, categories, and articles in ServiceNow.
...
The knowledge base endpoints create and manage knowledge bases, categories, and articles through the ServiceNow REST API.
