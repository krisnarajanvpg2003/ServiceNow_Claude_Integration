# User Management in ServiceNow REST API

This document provides detailed information about the User Management tools available in the ServiceNow REST API.
