...
This document outlines the plan for implementing catalog optimization features in the ServiceNow REST API.
...
### Phase 4: Integration
1. Register all tools in `src/servicenow_mcp/utils/tool_utils.py` (they become REST endpoints automatically)
