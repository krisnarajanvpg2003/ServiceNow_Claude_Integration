# Catalog Item Variables in ServiceNow REST API

This document describes the tools available for managing variables (form fields) in ServiceNow catalog items using the ServiceNow REST API.
...
- Change the order of fields in the hardware request form to put name first## Troubleshooting
