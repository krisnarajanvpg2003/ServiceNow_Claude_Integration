# Workflow Management in ServiceNow REST API

This document provides detailed information about the workflow management tools available in the ServiceNow REST API.
...
ServiceNow workflows are a powerful automation feature that allows you to define and automate business processes. The workflow management tools in the ServiceNow REST API enable you to view, create, and modify workflows in your ServiceNow instance.
